...
public class MatchesRepository implements IRepository<Match, Long> {
	...
	public boolean load(String path) {
		...
		matches.add(new Match("Club1", "Club2", new GregorianCalendar(2019, Calendar.FEBRUARY, 7, 19, 07, 15)));
		matches.add(new Match("Club2", "Club3", new GregorianCalendar(2019, Calendar.FEBRUARY, 7, 18, 50, 30)));
